...
#undef IS_EXTUI
  ...
  #if NONE(TFT_COLOR_UI, TFT_NEWCOLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI)
    #error "TFT_(COLOR|NEWCOLOR|CLASSIC|LVGL)_UI is required for your TFT. Please enable one."
  #elif MANY(TFT_COLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI)
    #error "Please select only one of TFT_(COLOR|NEWCOLOR|CLASSIC|LVGL)_UI."
  #endif
#elif ANY(TFT_COLOR_UI, TFT_NEWCOLOR_UI, TFT_CLASSIC_UI, TFT_LVGL_UI)
  #error "TFT_(COLOR|NEWCOLOR|CLASSIC|LVGL)_UI requires a TFT display to be enabled."
#endif
