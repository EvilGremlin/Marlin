...
#define Z_STEPPER_AUTO_ALIGN
   ...
   * driver order.
   */
  // #define Z_STEPPER_ALIGN_STEPPER_XY { { 5, 100 }, { 190, 100 } }
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 20*60, 5*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define LIN_ADVANCE
  ...
  #endif//#define ADVANCE_K_EXTRA       // Add a second linear advance constant, configurable with M900 L.
...
#define FILAMENT_WIDTH_SENSOR
  ...
  #define MEASUREMENT_DELAY_CM        10    // (cm) The distance from the filament sensor to the melting chamber
...
//#define POWER_MONITOR_VOLTAGE   // Monitor the system voltage
  ...
  #define POWER_MONITOR_VOLTS_PER_VOLT  0.090909  // Input voltage to the MCU analog pin per volt - DO NOT apply more than ADC_VREF!
